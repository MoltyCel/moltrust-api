...
# 8099 = MolTrust Explorer Dev (uvicorn, localhost only, no external exposure)
EXPECTED_PORTS="22 53 80 443 3003 5432 6379 8000 8001 8002 8004 8005 8099 8168 8282 9050 9740"
DISK_THRESHOLD=85
CERT_MIN_DAYS=14
BACKUP_MAX_DAYS=7
